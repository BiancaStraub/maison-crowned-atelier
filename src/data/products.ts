...
export const products: Product[] = [
  ...
  // Coleção Feminina
  { id: 'militarre', name: 'MILITARRE', subtitle: 'Tailleur Estruturado', fabric: 'Wool', color: 'Green Military', collection: 'feminina', price: 13000, description: 'Tailleur em lã verde militar. Estrutura e poder em cada costura.', images: makeImages('militarre') },
  { id: 'noir-sculpt', name: 'NOIR SCULPT', subtitle: 'Vestido Midi Gala', fabric: 'Zibeline', color: 'Black', collection: 'feminina', price: 14500, description: 'Vestido midi em zibeline preta. Escultura têxtil para noites de gala.', images: makeImages('noir-sculpt') },
  { id: 'essenza', name: 'ESSENZA', subtitle: 'Conjunto Pantalona', fabric: 'Crepe/Linen', color: 'Nude/Beige', collection: 'feminina', price: 11000, description: 'Pantalona e blusa em crepe e linho. A essência da fluidez elegante.', images: makeImages('essenza') },
  { id: 'breeze', name: 'BREEZE', subtitle: 'Chemise & Shorts', fabric: 'Linen', color: 'White/Beige', collection: 'feminina', price: 8500, description: 'Chemise e shorts em linho branco e bege. Brisa marítima materializada.', images: makeImages('breeze') },
